dataset_info = dict(
    dataset_name="llvip",
    paper_info=dict(
        author="Askat Kuzdeuov, Darya Taratynova, Alim Tleuliyev and Huseyin Atakan Varol",
        title="OpenThermalPose: An Open-Source Annotated Thermal Human Pose Dataset and Initial YOLOv8-Pose Baselines",
        container=" 2024 IEEE 18th International Conference on Automatic Face and Gesture Recognition (FG)",
        year="2024",
        homepage="https://github.com/IS2AI/OpenThermalPose?tab=readme-ov-file",
    ),
    keypoint_info={
